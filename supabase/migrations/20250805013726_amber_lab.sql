```sql
-- Remove foreign key constraint referencing dealer_profiles from applications table
ALTER TABLE IF EXISTS public.applications
  DROP CONSTRAINT IF EXISTS applications_dealer_id_fkey;

-- Remove dealer_id column from applications table if it exists
DO $$
BEGIN
  IF EXISTS (
...
-- Fix applications table RLS policies (removed dealer_id checks)
