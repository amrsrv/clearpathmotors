/*
  # Add is_admin column to user_profiles and update RLS policies

  1. New Columns
    - `is_admin` (boolean) added to user_profiles table
  ...
  3. Security
    ...
    - Add trigger to sync is_admin with JWT metadata for backward compatibility
*/
...
CREATE OR REPLACE FUNCTION log_admin_action(action_type TEXT)
RETURNS TRIGGER AS $$
DECLARE
