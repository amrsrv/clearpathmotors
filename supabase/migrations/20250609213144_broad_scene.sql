/*
  # Admin Features and Real-time Updates Migration
  ...
  3. Functions and Triggers
    ...
    - Application status update function based on stages
    - Admin message logging function
    - Triggers for real-time updates and notifications
...
-- Drop existing policies if they exist and create new ones for application_flags
...
-- Drop existing policies if they exist and create new ones for admin_settings
