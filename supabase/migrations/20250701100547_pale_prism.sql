/*
  ...
  1. Changes
    - Fix RLS policies for notifications, chats, and chat_messages
    - Allow NULL user_id in notifications table
    - Add temp_user_id to notifications table if it doesn't exist
    - Update RLS policies to handle anonymous users properly
    
  2. Security
    - Enable RLS on all tables
    - Update policies to properly check auth.uid()
*/
