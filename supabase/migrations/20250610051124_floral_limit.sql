/*
  ...
  3. Changes
    - Add real-time support for chat messages
*/
...
BEGIN
  ...
  LOOP
    ...
    FOR message_record IN SELECT * FROM jsonb_array_elements(chat_record.messages) AS message
    LOOP
      ...
      INSERT INTO chat_messages (
        ...
        CASE 
          WHEN message_record->>'role' = 'assistant' THEN 
            COALESCE((message_record->>'status' = 'read')::boolean, false)
          ELSE true
        END
      )
