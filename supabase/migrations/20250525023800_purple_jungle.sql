/*
  ...
  1. Security Changes
    ...
    - Fix permission issues for document uploads and notifications
    - Add cascading permissions for related tables

  2. Policies Added
    - Applications: view, insert, update for users and admins
    - Documents: view, upload for users and full access for admins
    - Notifications: view, update for users and full access for admins
    - Application Stages: view, insert for users and full access for admins
*/
