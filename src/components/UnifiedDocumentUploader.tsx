// CHANGES MADE:
// 1. Wrapped everything in a max-w-full, overflow-hidden container
// 2. Added flex-wrap to icon and filter rows
// 3. Added max-w and truncate rules to text and file name areas
// 4. Ensured no fixed width elements overflow
                  ...
                  <div className="p-3 flex items-center justify-between overflow-hidden" onClick={() => toggleFileExpand(docFile.id)}>
                    <div className="flex items-center space-x-3 overflow-hidden max-w-[80%]">
                      ...
                      <div className="overflow-hidden max-w-full">
                        <p className="font-medium text-gray-900 truncate">{docFile.file.name}</p>
