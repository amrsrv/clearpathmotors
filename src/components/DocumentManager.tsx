      ...
      <div className="space-y-6">
        {Object.entries(documentsByCategory).length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm mt-2">Upload your documents to proceed with your application</p>
          </div>
        ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          {doc.review_notes && (
                            <p className="mt-2 text-sm bg-gray-50 p-2 rounded text-gray-600 border border-gray-100">
                              {doc.review_notes}
                            </p>
                          )}
                        </div>
