...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border border-input bg-background px-4 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#3BAA75] focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 shadow-sm transition-all duration-200 form-input-shadow [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
